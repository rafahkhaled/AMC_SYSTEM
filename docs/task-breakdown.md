...
| P1-07 | Document upload and viewer UI, drag and drop, expiry badges | FR-04 | P1-06 | 1 |
| P1-08 | EmaraTax credential vault UI, permission-gated, every view logged | FR-05 | P0-14 | 0.5 |
...
| P1-18 | Tasks UI: board and list views, task detail with steps, documents and assignment | FR-12, FR-13 | P1-15 | 2 |
